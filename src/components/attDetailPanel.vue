        ...
        methods: {
            ...
            handleCandidateSelectedRowChange: function(newRow) {
                ...
                .then(function(response){
                    app.attendanceStatus = response.data.rows[0].presenceDescription.description
                }).catch(function(err){
                    alert(err)
                })
            },
            setCurrent(row) {
                ...
                this.$refs.candidateTable.setCurrentRow(row);
        },
